  ...
  return (
    <div className='Top_component'>
      <div className='Top_divIzquierda'>
        <h1 className='Top_h1'>Conectamos tu <span className='h1_nececidad'>nececidad</span> con los mejores <span className='h1_profesionales'>profesionales</span></h1>
        ...
        <Link to="/home" className='Top_buttonAcceder'>Prueba gratis<img className='new_tabIcon' src={newTab} alt="" /></Link>
      </div>
