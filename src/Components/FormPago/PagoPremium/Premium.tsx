...
const handleSubmit = async (e:any) => {
    ...
    const newPayment:{id:string, currentOffer:any, name:string, lastname:string, DNI:number, Email:string, Phone_Number:number, Direction:string, Postal_code:number, city:string, province:string, country:string} = {
       id:userLogged.id , currentOffer ,name, lastname, DNI, Email, Phone_Number, Direction, Postal_code, city, province, country
    }
        ...
        <div className='PremiumPost_divcontent'>
            <div className='premium_benefices'>
                ...
                <div className='premium_benefices_inputs'>
                  ...
                  <img  className='premiumPost_image' src={image1} alt="corona" />
                  <p className='price_p'><b>ARS$ 1.000</b>/mes</p>
                  <p className='libre'>Libre de impuestos</p>
                  <br />
                  <h3><GiCheckMark className='check_icon'/> Consigue mayores posibilidades de ser seleccionado <b>¡revisa y supera las 
                    propuestas de tus competidores!</b>
                  </h3>
                  <br />
                  <h3><GiCheckMark className='check_icon'/> Modifica tus propuestas para adaptarlas mejor <b>¡Adaptate y triunfaras!</b></h3>
                  <br />
                  <h3><GiCheckMark className='check_icon'/> Recibe el pago por tu trabajo en un menor tiempo que los demas, <b>¡Te daremos prioridad!</b></h3>
                </div>
              </div>
