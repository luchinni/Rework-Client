...
const DetailOffer = () => {
  ...
  const proposalAccepted = offerId?.proposals?.find(
    (p: any) => p.state === "accepted"
  );
  const contractAccepted = offerId?.proposals?.find(
    (p: any) => p.state === "contract accepted"
  );
  const contractStarted = offerId?.proposals?.find(
    (p: any) => p.state === "contract started"
  );
  const proposalFinalized = offerId?.proposals?.find(
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <div
            className={open ? "Detail_component modalOpen" : "Detail_component"}
          >
            <Header />
              ...
              currentUser?.isPremium === false &&
                ...
                <div className="Detail_divCardPropuestas">
                  ...
                  <div className="Detail_premiumCont">
                    <div className="Detail_premiumBack"></div>
                    <div className="Detail_premium">
                      <span>
                        ¿Quieres ver las propuestas de otros freelancers?
                      </span>
